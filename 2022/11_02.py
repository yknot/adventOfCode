...
class Monkey:
    ...
    def string(self):
        return f"  Items: {[i.value for i in self.items]}\n"
...
def run_monkies(container: Container, test=True):
    lcm = 96577 if test else 9699690
...
assert run_monkies(test_c) == 2713310158

assert run_monkies(inpt, test=False) == 21553910156
